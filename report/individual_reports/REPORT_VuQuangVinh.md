...
4.  **Nguyên lý Thiết kế Hướng Công cụ (Tại sao ép Agent chỉ trả về âm thanh?)**: Quyết định thiết kế này nhằm đảm bảo tính **Phân tách Trách nhiệm (Separation of Concerns)**. Nếu cho phép Agent trả lời bằng văn bản dài dòng hoặc chỉ sinh code thuần, nó sẽ có xu hướng "lười biếng" và hành xử giống hệt Chatbot Baseline, làm mất đi ý nghĩa của luồng ReAct. Việc khóa chặt Agent vào mục tiêu duy nhất là "bắt buộc phải xuất ra file .wav" giúp nó tập trung 100% tài nguyên để cấu hình tham số JSON chính xác nhất, đồng thời nhường lại hoàn toàn mảng giao tiếp văn bản cho luồng Smart Router xử lý để tối ưu chi phí.
